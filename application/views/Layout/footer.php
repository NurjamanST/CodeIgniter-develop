		<!-- Vendor JS Files in Folder Assets ==============================================================================================-->
		...
		<!-- End Vendor JS Files in Folder Assets --> 
		...
		<!-- Include JS Internal Code ==============================================================================================-->
			<!-- Navbar Scroll Setup Landing Page -->
				<script>
			...
			<!-- END Navbar Scroll Setup Landing Page-->
			
			<!-- Menampilan Koleksi & Kategori Pada Form add produk  -->
				<script>
			...
			<!-- END Menampilan Koleksi & Kategori Pada Form add produk  -->


			<!-- Preview gambar saat upload poto produk di add atau edit modal produk -->
				<script>
			...
			<!-- END Preview gambar saat upload poto produk di add atau edit modal produk -->

			
			<!-- Inisialisasi Quill untuk modal add produk -->
				<script>
					// Inisialisasi Quill editor add produk
					const quill = new Quill('#quillEditoraddprod', {
						theme: 'snow',
						modules: {
						toolbar: [
							[{ 'header': [1, 2, false] }],
					...
					// Sinkronisasi isi editor ke hidden textarea saat submit
					document.querySelector("form").onsubmit = function() {
						document.getElementById('addprodketerangan').value = quill.root.innerHTML;
					};
				</script>
			<!-- END Inisialisasi Quill untuk modal add produk -->
			

			<!-- Mengirim data ke Modal Delete produk -->
				<script>
			...
			<!-- END Mengirim data ke Modal Delete produk -->
			

			<!-- Mengirim data ke Modal Edit produk -->
				<script>
					...
					function openEditModal(product) {
						...
						// Set konten lama
						// quillEdit.root.innerHTML = product.keterangan;

						// Set Koleksi
						$('#edit_koleksiSelect').val(product.koleksi_id).trigger('change');

						// Tunggu dikit supaya kategori load
						setTimeout(function() { $('#edit_kategoriSelect').val(product.kategori_id); }, 500);
				...
				<script>
					...
					const editQuill = new Quill('#quillEditoreditprod', {
						theme: 'snow'
					});
			...
			<!-- END Mengirim data ke Modal Edit produk -->

			<!-- Inisialisasi Quill untuk modal add News -->
				<script>
					// Inisialisasi Quill editor untuk Add News
					const quillEditoraddnews = new Quill('#quillEditoraddnews', {
						theme: 'snow',
						modules: {
							toolbar: [
								[{ 'header': [1, 2, false] }],
					...
					// Sinkronisasi isi editor ke hidden textarea saat submit
					document.querySelector("#addNewsForm").onsubmit = function() {
						document.getElementById('addnewsketerangan').value = quillEditoraddnews.root.innerHTML;
					};
				</script>
			<!-- END Inisialisasi Quill untuk modal add News -->

			<!-- Mengirim data ke Modal Edit News -->
				<script>
			...
			<!-- END Mengirim data ke Modal Edit News -->

			
			<!-- Inisialisasi Quill untuk Edit News -->
				<script>
			...
			<!-- END Edit Narasi Quill -->

			<!-- Mengirim data ke Modal Delete produk -->
				<script>
					// Fungsi untuk konfirmasi dan buka modal hapus
					function openDeleteModalNews(data) {
						// Set id ke input hidden
						document.getElementById('delete_id').value = data.id;
						document.getElementById('deleteNewsTitle').textContent = data.judul;
			...
			<!-- JavaScript: Buka Modal Edit Saat Card Slider Diklik -->
				<script>
			...
			<!-- END JavaScript: Buka Modal Edit Saat Card Slider Diklik -->
