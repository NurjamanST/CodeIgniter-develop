        ...
        <div class="card border-0 rounded-3 shadow-sm">
            ...
            <div class="card-body d-flex flex-wrap justify-content-between align-items-start">
                ...
                <div class="mb-3 mb-md-0">
                    <h5 class="card-title mb-1"><?= $collection->nama_koleksi ?></h5>
                    <p class="card-text text-secondary mb-0 mt-1">
                        Menampilkan <span id="productCount"><?= count($products) ?></span> produk dalam koleksi ini.
                    </p>
                </div>
                           ...
                           class="text-decoration-none text-dark">
                            <div class="bg-white rounded-3 shadow-sm w-100 d-flex flex-column"
                                ...
                                onmouseout="this.style.transform='scale(1)';">
                       		  ...
                       		  <!-- Gambar Produk -->
                    <div class="position-relative overflow-hidden d-flex align-items-center justify-content-center bg-light" style="height: 180px;">
                        <img src="<?= !empty($product->first_image) ? base_url('uploads/products/' . $product->first_image) : base_url('assets/img/no-image.png') ?>"
                             ...
                             style="max-height: 100%; max-width: 100%; transition: transform 0.3s ease;"
...
<!-- JavaScript untuk Sorting dengan Direct Swap - SAMA PERSIS -->
<script>
